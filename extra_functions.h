...
/**
 * @brief Creates an array containing all of the given cell's adjacent cells (including diagonals)
 * @param g the game
 * @param i row index
...
/**
 * @brief Creates an array containing all of the given cell's orthogonally adjacent cells
 * @param g the game
 * @param i row index
 * @param j column index
 * @return the array containing the width and height of the cells
